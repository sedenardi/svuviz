...
templates['actorModal-template'] = template({"1":function(depth0,helpers,partials,data) {
  ...
  var stack1, buffer = "";
  stack1 = this.invokePartial(partials['actorRow-partial'], '  ', 'actorRow-partial', depth0, undefined, helpers, partials, data);
  if (stack1 != null) { buffer += stack1; }
  return buffer;
...
templates['actorRow-partial'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = "<div class=\"row alternateRow\">\n  <div class=\"col-xs-6\">\n  ";
...
templates['commonModal-template'] = template({"1":function(depth0,helpers,partials,data) {
  var stack1, buffer = "<h4>TV Shows</h4>\n";
  stack1 = helpers.each.call(depth0, ((stack1 = (depth0 != null ? depth0.processed : depth0)) != null ? stack1.tv : stack1), {"name":"each","hash":{},"fn":this.program(2, data),"inverse":this.noop,"data":data});
  if (stack1 != null) { buffer += stack1; }
  return buffer;
  ...
  var stack1, buffer = "";
  stack1 = this.invokePartial(partials['commonRow-partial'], '  ', 'commonRow-partial', depth0, undefined, helpers, partials, data);
  if (stack1 != null) { buffer += stack1; }
  return buffer;
},"4":function(depth0,helpers,partials,data) {
  var stack1, buffer = "<h4>Movies</h4>\n";
  ...
  var stack1, helperMissing=helpers.helperMissing, buffer = "<div class=\"row commonHeader\">\n  <div class=\"col-xs-4\">\n    <h4>\n    ";
...
templates['commonRow-partial'] = template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
  var stack1, helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = "<div class=\"row alternateRow\">\n<div class=\"col-xs-4\">\n";
